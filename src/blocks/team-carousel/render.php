...
if ( ! $members_query->have_posts() ) {
	...
	echo '<p class="brilliant-team-carousel__empty">' . esc_html__( 'No team members found.', 'brilliant' ) . '</p>';
	echo '</div>';
	return;
}
?>
...
<div <?php echo $wrapper_attributes; ?>>
	...
	<?php if ( $show_arrows ) : ?>
	<div class="swiper-custom-prev gu-nav" aria-label="<?php esc_attr_e( 'Previous', 'brilliant' ); ?>">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
			<path d="M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6z"/>
		</svg>
	</div>
	<div class="swiper-custom-next gu-nav" aria-label="<?php esc_attr_e( 'Next', 'brilliant' ); ?>">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
	...
	<div
		class="brilliant-team-carousel__popup"
		role="dialog"
		aria-modal="true"
		aria-hidden="true"
		aria-label="<?php esc_attr_e( 'Team member profile', 'brilliant' ); ?>"
	>
		<div class="brilliant-team-carousel__popup-overlay" aria-hidden="true"></div>

		<div class="brilliant-team-carousel__popup-dialog">

			<button
				class="brilliant-team-carousel__popup-close"
			...
			<div class="brilliant-team-carousel__popup-content">
