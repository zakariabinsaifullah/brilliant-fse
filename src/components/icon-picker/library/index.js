...
export default function Library({
    ...
    return (
        <Modal
            overlayClassName="brilliant-modal__overlay"
            className={`brilliant-modal is-${activeTab}`}
            title={__('Icons Library', 'brilliant')}
            onRequestClose={onClose}
            isFullScreen={true}
            headerActions={<Header activeTab={activeTab} onTabChange={onTabChange} />}
        >
            <div className="brilliant-modal__container">
                <Sidebar
                ...
                />
                <div className="brilliant-modal__content">
